...
module.exports = (scenario) => {
  scenario("testing out how conductor should be set up", async (s, t) => {
    ...
    const checking_key_1 = await liza.call('dpki_happ', "dpki", "key_status", {
      key: AGENT_SIG_KEY_1
    })
    ...
    let registered_key = await liza.call('dpki_happ', "dpki", "register_key", {
      app_dna_hash: "Qem...",
      app_name: "App Name...",
      public_key: all_keys.Ok[0].newKey
    })
    ...
    registered_key = await liza.call('dpki_happ', "dpki", "register_key", {
      app_dna_hash: "Qww...",
      app_name: "App2 Name...",
      public_key: all_keys.Ok[0].newKey
    })
    ...
    */
    ...
    const checking_key_2 = await liza.call('dpki_happ', "dpki", "key_status", {
      key: AGENT_SIG_KEY_1
    })
    t.deepEqual(checking_key_2.Ok, "live")

    // Ceecking Agents initial Encryption key
    const checking_key_3 = await liza.call('dpki_happ', "dpki", "key_status", {
      key: AGENT_ENC_KEY_1
    })
    ...
    const checking_key_4 = await liza.call('dpki_happ', "dpki", "key_status", {
      key: AGENT_SIG_KEY_1
    })
    t.deepEqual(checking_key_4.Ok, "modified")

    const checking_key_5 = await liza.call('dpki_happ', "dpki", "key_status", {
      key: AGENT_SIG_KEY_2
    })
    ...
    const checking_key_6 = await liza.call('dpki_happ', "dpki", "key_status", {
      key: AGENT_ENC_KEY_1
    })
