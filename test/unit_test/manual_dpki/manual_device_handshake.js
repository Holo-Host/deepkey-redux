...
async function jack_conductor_init (agent){
  return await agent.callSync("dpki_happ", "dpki", "init_dpki",  {params: "{\"signed_auth_key\":\"sCkN1Yqaxeso1JicovXBruDXtx20Sofa+I6A6xpe3LjJQ6zvqwrJ3qbbDgLmFIPqF5RAKWTSMI7BZr6+06k/DA==\"}"})
}
