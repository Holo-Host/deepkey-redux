...
module.exports = (scenario) => {
  scenario("testing the init process", async(s, t) => {
    ...
    let get_init_data = await liza.callSync('dpki_happ', "dpki", "get_initialization_data", {})
    console.log("Rules: ", get_init_data);
    t.ok(get_init_data.Ok)

    let get_rules = await liza.callSync('dpki_happ', "dpki", "get_rules", {})
    console.log("Rules: ", get_rules);
    t.ok(get_rules.Ok)

    let get_auth = await liza.callSync('dpki_happ', "dpki", "get_authorizor", {})
